...
c---------------------------------------------------------------------
c 5th order Weno-JS reconstruction
c---------------------------------------------------------------------
...
c---------------------------------------------------------------------
c MC limiter of van Leer, set beta=1 to make it tvd
c---------------------------------------------------------------------
...
c     backward, forward and central differences
      dul = u0  - um1
      dur = up1 - u0
      duc = 0.5 * (up1 - um1)

      u = u0 + 0.5 * minmod(beta*dul, duc, beta*dur)
